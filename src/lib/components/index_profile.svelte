  ...
  {#if site.author.resume}
    <div class="dropdown dropdown-end dropdown-top self-end">
      ...
      <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box mb-1">
        <li><a href={site.author.resume} download class="btn btn-secondary m-1 ">English</a></li>
        <li><a href={site.author.resumeFr} download class="btn btn-secondary m-1 ">French</a></li>
      </ul>
    </div>
  {/if}
</div>
